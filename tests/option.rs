...
fn u128_be() {
    let mut data =
        hex!("0102030405060708090A0B0C0D0E0F10 80000000000000000000000000000000").as_ref();
    assert!(matches!(
        data.read_u128::<BigEndian>(),
        Some(1339673755198158349044581307228491536)
    ));
    assert!(matches!(
        data.read_u128::<BigEndian>(),
...
fn i128_le() {
    let mut data =
        hex!("100F0E0D0C0B0A090807060504030201 00000000000000000000000000000080").as_ref();
    assert!(matches!(
        data.read_i128::<LittleEndian>(),
        Some(1339673755198158349044581307228491536)
    ));
    assert!(matches!(
        data.read_i128::<LittleEndian>(),
...
fn uint_be() {
    ...
    assert!(matches!(
        data.read_uint128::<BigEndian>(5),
        Some(4328719365)
    ));
    assert!(matches!(
        data.read_uint128::<BigEndian>(6),
        Some(1108152157446)
    ));
    assert!(matches!(
        data.read_uint128::<BigEndian>(7),
        Some(283686952306183)
    ));
    assert!(matches!(
        data.read_uint128::<BigEndian>(8),
        Some(72623859790382856)
    ));
    assert!(matches!(
        data.read_uint128::<BigEndian>(9),
        Some(18591708106338011145)
    ));
    assert!(matches!(
        data.read_uint128::<BigEndian>(10),
        Some(4759477275222530853130)
    ));
    assert!(matches!(
        data.read_uint128::<BigEndian>(11),
        Some(1218426182456967898401291)
    ));
    assert!(matches!(
        data.read_uint128::<BigEndian>(12),
        Some(311917102708983781990730508)
    ));
    assert!(matches!(
        data.read_uint128::<BigEndian>(13),
        Some(79850778293499848189627010061)
    ));
    assert!(matches!(
        data.read_uint128::<BigEndian>(14),
        Some(20441799243135961136544514575630)
    ));
    assert!(matches!(
        data.read_uint128::<BigEndian>(15),
        Some(5233100606242806050955395731361295)
    ));
    assert!(matches!(
        data.read_uint128::<BigEndian>(16),
        Some(1339673755198158349044581307228491536)
    ));
}
...
fn uint_le() {
    ...
    assert!(matches!(
        data.read_uint128::<LittleEndian>(4),
        Some(16909060)
    ));
    assert!(matches!(
        data.read_uint128::<LittleEndian>(5),
        Some(4328719365)
    ));
    assert!(matches!(
        data.read_uint128::<LittleEndian>(6),
        Some(1108152157446)
    ));
    assert!(matches!(
        data.read_uint128::<LittleEndian>(7),
        Some(283686952306183)
    ));
    assert!(matches!(
        data.read_uint128::<LittleEndian>(8),
        Some(72623859790382856)
    ));
    assert!(matches!(
        data.read_uint128::<LittleEndian>(9),
        Some(18591708106338011145)
    ));
    assert!(matches!(
        data.read_uint128::<LittleEndian>(10),
        Some(4759477275222530853130)
    ));
    assert!(matches!(
        data.read_uint128::<LittleEndian>(11),
        Some(1218426182456967898401291)
    ));
    assert!(matches!(
        data.read_uint128::<LittleEndian>(12),
        Some(311917102708983781990730508)
    ));
    assert!(matches!(
        data.read_uint128::<LittleEndian>(13),
        Some(79850778293499848189627010061)
    ));
    assert!(matches!(
        data.read_uint128::<LittleEndian>(14),
        Some(20441799243135961136544514575630)
    ));
    assert!(matches!(
        data.read_uint128::<LittleEndian>(15),
        Some(5233100606242806050955395731361295)
    ));
    assert!(matches!(
        data.read_uint128::<LittleEndian>(16),
        Some(1339673755198158349044581307228491536)
    ));
}
...
fn int_be() {
    ...
    assert!(matches!(
        data.read_int128::<BigEndian>(4),
        Some(-2122153084)
    ));
    assert!(matches!(
        data.read_int128::<BigEndian>(5),
        Some(-543271189371)
    ));
    assert!(matches!(
        data.read_int128::<BigEndian>(6),
        Some(-139077424478842)
    ));
    assert!(matches!(
        data.read_int128::<BigEndian>(7),
        Some(-35603820666583417)
    ));
    assert!(matches!(
        data.read_int128::<BigEndian>(8),
        Some(-9114578090645354616)
    ));
    assert!(matches!(
        data.read_int128::<BigEndian>(9),
        Some(-2333331991205210781559)
    ));
    assert!(matches!(
        data.read_int128::<BigEndian>(10),
        Some(-597332989748533960078966)
    ));
    assert!(matches!(
        data.read_int128::<BigEndian>(11),
        Some(-152917245375624693780215157)
    ));
    assert!(matches!(
        data.read_int128::<BigEndian>(12),
        Some(-39146814816159921607735080052)
    ));
    assert!(matches!(
        data.read_int128::<BigEndian>(13),
        Some(-10021584592936939931580180493171)
    ));
    assert!(matches!(
        data.read_int128::<BigEndian>(14),
        Some(-2565525655791856622484526206251634)
    ));
    assert!(matches!(
        data.read_int128::<BigEndian>(15),
        Some(-656774567882715295356038708800418161)
    ));
    assert!(matches!(
        data.read_int128::<BigEndian>(16),
        Some(-168134289377975115611145909452907049192)
    ));

    assert!(matches!(
        hex!("FF7F").as_ref().read_int128::<BigEndian>(2),
        Some(-129)
    ));
}
...
fn int_le() {
    ...
    assert!(matches!(
        data.read_int128::<LittleEndian>(3),
        Some(-8289661)
    ));
    assert!(matches!(
        data.read_int128::<LittleEndian>(4),
        Some(-2122153084)
    ));
    assert!(matches!(
        data.read_int128::<LittleEndian>(5),
        Some(-543271189371)
    ));
    assert!(matches!(
        data.read_int128::<LittleEndian>(6),
        Some(-139077424478842)
    ));
    assert!(matches!(
        data.read_int128::<LittleEndian>(7),
        Some(-35603820666583417)
    ));
    assert!(matches!(
        data.read_int128::<LittleEndian>(8),
        Some(-9114578090645354616)
    ));
    assert!(matches!(
        data.read_int128::<LittleEndian>(9),
        Some(-2333331991205210781559)
    ));
    assert!(matches!(
        data.read_int128::<LittleEndian>(10),
        Some(-597332989748533960078966)
    ));
    assert!(matches!(
        data.read_int128::<LittleEndian>(11),
        Some(-152917245375624693780215157)
    ));
    assert!(matches!(
        data.read_int128::<LittleEndian>(12),
        Some(-39146814816159921607735080052)
    ));
    assert!(matches!(
        data.read_int128::<LittleEndian>(13),
        Some(-10021584592936939931580180493171)
    ));
    assert!(matches!(
        data.read_int128::<LittleEndian>(14),
        Some(-2565525655791856622484526206251634)
    ));
    assert!(matches!(
        data.read_int128::<LittleEndian>(15),
        Some(-656774567882715295356038708800418161)
    ));
    assert!(matches!(
        data.read_int128::<LittleEndian>(16),
        Some(-168134289377975115611145909452907049192)
    ));
}
